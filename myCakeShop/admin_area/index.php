...
<body>
    ...
    <div class="container-fluid p-0">
        ...
        <div class="bg-secondary">
            <h4 class="text-center p-2 text-light">Manage Details</h4>
          </div>
          ...
          <div class="row">
            <div class="col-md-12 bg-light p-1 d-flex align-center">
                ...
                <div class="text-center align-center m-auto">
                    <a href="index.php?insert_product" class="btn btn-primary my-2" role="button">Insert Products</a>
                    <a href="#" class="btn btn-primary my-2" role="button">View More</a>
